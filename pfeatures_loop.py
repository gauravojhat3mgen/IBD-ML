...
pos_file_url = "https://raw.githubusercontent.com/gauravsucks/IBD-ML/main/benchmarking-positive.txt"
negative_file_url = "https://raw.githubusercontent.com/gauravsucks/IBD-ML/main/benchmarking-negative.txt"
...
############### COPY AND PASTE THIS PART INTO THE NOTEBOOK  AT THE POINT OF PROCESSING THE FILES WITH PFEATURE (DON'T FORGET TO IMPORT Pfeature * ########################
from Pfeature import pfeature
#Create a dictionary of the fmunctions and their names to iterate through so as to get the right description for looping through and automating the functions
pfeatures = {
